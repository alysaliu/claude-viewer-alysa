...
// Sample data for documents and recipes
export const recentDocuments = [
  { id: 1, name: 'Police Report - Davis Case', type: 'PDF', date: '2024-01-15' },
  { id: 2, name: 'Medical Records - Johnson', type: 'DOC', date: '2024-01-14' },
  { id: 3, name: 'Insurance Claim Form', type: 'PDF', date: '2024-01-13' }
];

export const allDocuments = [
  ...recentDocuments,
  { id: 4, name: 'Witness Statement 1', type: 'PDF', date: '2024-01-12' },
  { id: 5, name: 'Witness Statement 2', type: 'PDF', date: '2024-01-11' },
  { id: 6, name: 'Expert Analysis Report', type: 'DOC', date: '2024-01-10' }
];

export const recentRecipes = [
  { id: 1, name: 'Personal Injury Complaint', category: 'Complaint', uses: 45 },
  { id: 2, name: 'Motion for Summary Judgment', category: 'Motion', uses: 23 },
  { id: 3, name: 'Discovery Request', category: 'Discovery', uses: 67 }
];